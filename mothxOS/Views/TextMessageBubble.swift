...
struct TextMessageBubble: View {
    ...
    private var displayText: String {
        if isCurrentRunning {
            return String(message.displayText.prefix(displayedCharCount))
        }
        return message.displayText
    }

    private var isTyping: Bool {
        isCurrentRunning && displayedCharCount < message.displayText.count
    }
    ...
    var body: some View {
        ...
        .onChange(of: message.displayText) { _, newText in
            if isCurrentRunning && displayedCharCount < newText.count {
